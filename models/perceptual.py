...
class PerceptualLoss(nn.Module):
    def __init__(self, network='vgg19', layers=['relu_1_1', 'relu_2_1', 'relu_3_1', 'relu_4_1', 'relu_5_1'],
                 weights=None,
                 criterion='l1', resize=True, resize_mode='bilinear',
                 instance_normalized=False, num_scales=3,
                 use_style_loss=True, weight_style_to_perceptual=1000):
        super().__init__()
